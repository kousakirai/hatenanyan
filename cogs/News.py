...
class News(commands.Cog):
  ...
  def news_get(self):
    ...
    rss_url_list = []
    rss_url_list.append('https://www.news24.jp/rss/index.rdf') #AUTOMATONのRSS-URL
    rss_url_list.append('https://www.sankeibiz.jp/rss/news/flash.xml') #GameSparkのRSS-URL
    rss_url_list.append('https://news.yahoo.co.jp/rss/categories/domestic.xml') #4GamerのRSS-URL
 
    #各ログのファイルパス
    log_path_list = []
    log_path_list.append('cogs/Newslogs/asahi_log.txt') #AUTOMATONのlogファイルパス
    log_path_list.append('cogs/Newslogs/sankei_log.txt') #GameSparkのlogファイルパス
